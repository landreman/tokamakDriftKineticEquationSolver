    ...
    subroutine computedBdthetas(thetas, dBdthetas)
      ...
      select case (geometryToUse)
        ...
        case (GEOMETRY_MILLER)
          ...
          call makeFourierSpectralDifferentiationMatrix(N, zero, two*pi, thetaFine, spectralDerivative)
          ! Shift the elements by 1, since we need the first element to be zero:
          do i=N,2,-1
            thetaFine(i)=thetaFine(i-1)
          end do
          thetaFine(1)=zero
